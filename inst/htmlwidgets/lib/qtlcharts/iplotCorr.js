...
iplotCorr = function(widgetdiv, data, chartOpts) {
  ...
  // chartOpts start
  height = (ref = chartOpts != null ? chartOpts.height : void 0) != null ? ref : widgetdiv.clientHeight; // height of each panel in pixels
  width = (ref1 = chartOpts != null ? chartOpts.width : void 0) != null ? ref1 : widgetdiv.clientWidth; // total width of panels
